...
public class StartTomcat implements Runnable {
	...
	public void runtomcatserver() {
		try {
			...
			String[] CMD = file.getProperty("Startup.Win.TOMCAT_CMD").replace("<replacement_path>", SystemProperties.getCurrentPath()+File.separator+file.getProperty("tomcat.parent.dir")+File.separator+file.getProperty("Config.AppServer")).split(",");
